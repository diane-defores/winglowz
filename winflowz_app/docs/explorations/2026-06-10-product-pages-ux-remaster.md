...
docs_impact: yes
linked_systems:
  - "winflowz_app/lib/core/widgets/app_components.dart"
  - "winflowz_app/lib/features/shell/presentation/app_shell_screen.dart"
  - "winflowz_app/lib/features/voice/presentation/voice_screen.dart"
  - "winflowz_app/lib/features/clipboard/presentation/clipboard_screen.dart"
  - "winflowz_app/lib/features/snippets/presentation/snippets_screen.dart"
  - "winflowz_app/lib/features/dictionary/presentation/dictionary_screen.dart"
  - "winflowz_app/lib/core/sync/cloud_sync_overview.dart"
evidence:
...
depends_on:
  ...
  - "docs/COMPONENTS.md"
supersedes: []
next_step: "/sf-spec WinFlowz product pages UX remaster"
---
...
How should WinFlowz improve the UX and interface consistency of the main product pages: voice, clipboard, snippets, dictionary, and related sync/status surfaces?
...
- User story seed: As a WinFlowz user, I want the main pages to use the same compact structure so I can move between voice, paper, snippets, and dico without relearning the interface.
- Scope in seed:
...
- Recommended next command: `/sf-spec WinFlowz product pages UX remaster`
...
|----------|--------------|--------|--------|-----------|
| 2026-06-10 15:02:56 UTC | Explore UX/UI improvements for product pages, compactness, repetition, sync, and consistency | Read common widgets, shell, main product screens, and sync models | Identified shared page-frame opportunity and sync-display split | `/sf-spec WinFlowz product pages UX remaster` |
