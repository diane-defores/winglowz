...
- Quelles 3 sources externes "marché" sont validées officiellement pour les docs WinGlows ?
- Faut-il maintenir une section "Communautés" ici, ou la déplacer dans `shipglowz_data/business/gtm.md` ?
