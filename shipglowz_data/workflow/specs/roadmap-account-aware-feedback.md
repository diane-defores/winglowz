...
- `shipglowz_data/technical/architecture.md` must mention the new roadmap feedback API and tables

# Documentation Coherence

- Update `shipglowz_data/technical/architecture.md` to document roadmap feedback routes and Convex tables
...
- [ ] Task 6: Refresh technical docs for the new contract
  - Fichier : `shipglowz_data/technical/architecture.md`
