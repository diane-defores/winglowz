...
non_goals: "Building a generic cross-platform productivity brand, teaching every possible tool, or positioning WinGlowz as enterprise IT software"
...
WinGlowz targets Windows-first users who need a coherent productivity system:
...
1. Discover and qualify through educational and commercial pages.
2. Evaluate `Windows Mastery` as the primary offer.
3. Authenticate, purchase, and unlock gated learning surfaces.
4. Learn and apply through premium documentation and training content.
5. Extend through companion product surfaces without losing flagship focus.

## Scope In

- bilingual Astro marketing site
- `Windows Mastery` as central commercial offer
- gated docs and training surfaces under content collections
- companion product catalog entries in `src/content/products/`
- newsletter capture and lifecycle entry points

## Scope Out

- enterprise team administration or fleet management
...
- activation into gated lessons and docs
