...
- script utility landing pages: `/termux`, `/dotfiles`, `/shipglowz` and French equivalents
...
```bash
pnpm build:check
python3 /home/claude/shipglowz/tools/shipglowz_metadata_lint.py shipglowz_data/technical/context.md
```
