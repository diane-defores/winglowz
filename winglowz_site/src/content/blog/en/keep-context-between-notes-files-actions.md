...
# How to keep context between notes, files, and actions

Context is the difference between a useful note and a forgotten note.

## Why context breaks

Most people do not lose ideas because they never write them down. They lose them because the note lives alone. It is disconnected from the file, the next task, and the place where the work actually happens.

That is a workflow problem, not a memory problem.

## The three things you need to connect

To keep context alive, the system has to connect:
...
## How to keep context in practice

Try this pattern:

- capture in a single style
- label the next action explicitly
- keep unfinished work in one visible place
- review the same source before starting again

That does not require perfect discipline. It requires a workflow that makes the right thing easier.
