...
# Comment transformer une idée floue en plan clair sur Windows

Les idées ne manquent pas. Ce qui manque, c’est souvent la forme.

## Pourquoi les idées restent floues

Une idée reste floue parce que la prochaine étape n’a pas été définie.
On connaît la direction générale, mais on n’a pas encore répondu à :
...
Là encore, un système aide.

## La séquence de clarté

Avant d’exécuter, forcez l’idée à passer par quatre questions :

1. Quel est le résultat attendu ?
2. Quelle est la plus petite prochaine étape utile ?
3. Qu’est-ce qui dépend du fait que ce soit clair ?
4. Qu’est-ce qui peut être ignoré maintenant ?
...
L’exécution n’est pas spectaculaire. Elle ressemble généralement à :

- une note claire
- une tâche claire
- un contexte clair
- un endroit simple pour reprendre plus tard

Cela suffit souvent à préserver l’élan.
