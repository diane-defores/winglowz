---
title: "Le Focus — Ta ressource la plus précieuse"
description: "Construis un système de focus: moins de cibles concurrentes, moins de friction, plus de travail réellement profond."
sidebar:
  label: "Focus"
  order: 5
---
...
1. **Est-ce que la cible est claire ?**
2. **Est-ce qu'une autre source de stimulation est plus facile ou plus attractive ?**
3. **Est-ce que l'environnement protège vraiment l'attention ?**
4. **Est-ce que le problème est le focus, ou simplement la fatigue ?**
...
1. définis la seule tâche qui mérite la session
2. prépare le point d'entrée concret
3. enlève les sorties de secours évidentes
4. décide à l'avance quand la session se termine
...
- **[Freedom](https://freedom.to/)** si tu veux bloquer sites et apps sur plusieurs appareils
- **[Cold Turkey](https://getcoldturkey.com/)** si tu veux un blocage plus dur côté desktop
- **[News Feed Eradicator](https://chromewebstore.google.com/detail/news-feed-eradicator/cbjlelhojkbifolcocmiijgdpjfpokkk)** si le vrai problème est le scroll sur les feeds
- **[DeArrow](https://dearrow.ajay.app/)** si YouTube te capture surtout par les titres et miniatures
...
- **[Dark Reader](https://darkreader.org/)** pour rendre le web moins agressif visuellement
- **[I don't care about cookies](https://chromewebstore.google.com/detail/i-dont-care-about-cookies/fihnjjcciajhdojfnbdddfaoknhalnja)** pour masquer une partie des bannières cookies les plus pénibles
- **[Auto Dark Mode](https://github.com/AutoDarkMode/Windows-Auto-Night-Mode)** pour adapter automatiquement l'affichage selon l'heure
...
- **[RescueTime](https://www.rescuetime.com/)** pour voir automatiquement où va ton temps et lancer des Focus Sessions
- **[Clockify](https://clockify.me/)** si ton enjeu principal est le suivi structuré par projet, client ou tâche
...
1. remarque l'envie d'échapper à la tâche
2. demande-toi ce que tu essaies d'éviter
3. réduis l'action à une entrée supportable
...
Si tu veux quelque chose de sobre, **[wnr](https://getwnr.com/)** reste un bon choix minimaliste.
...
- **[Brain.fm](https://www.brain.fm/)** si tu veux un service pensé pour le focus
- **[Noisli](https://www.noisli.com/)** si tu veux construire des ambiances simples et personnalisées
...
L'ordre correct est :
1. ne pas ouvrir l'email en continu
2. transformer les vrais engagements en tâches
3. utiliser une interface plus propre seulement si le système tient déjà

Outils encore pertinents si tu veux alléger l'interface :
- **[Shortwave](https://www.shortwave.com/)** pour une logique email plus moderne
- **[Superhuman](https://superhuman.com/)** si l'email est un poste de travail central et intensif
- **[Simplify Gmail](https://on.simpl.fyi/about)** si tu veux juste une interface Gmail plus sobre
- **[cloudHQ](https://www.cloudhq.net/apps)** si tu veux explorer un vrai toolbox de productivité Gmail et navigateur, dont **Pause Gmail** n'est qu'un exemple
...
<details>
  ...
  - [Cal Newport](https://calnewport.com/writing/) — sur le travail profond et la protection de l'attention
  - [Nir Eyal — Indistractable](https://www.nirandfar.com/indistractable/) — utile pour penser triggers internes et externes
  - [Frank Slootman — The Knowledge Project](https://fs.blog/knowledge-project-podcast/frank-slootman/) — sur le coût réel de la dispersion
</details>
