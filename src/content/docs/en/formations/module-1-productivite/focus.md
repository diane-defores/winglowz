---
title: "Focus - Your Most Valuable Resource"
description: "Build a focus system: fewer competing targets, less friction, more genuinely deep work."
sidebar:
  label: "Focus"
  order: 5
---
...
- **[Freedom](https://freedom.to/)** if you want cross-device blocking for websites and apps
- **[Cold Turkey](https://getcoldturkey.com/)** if you want stricter desktop blocking
- **[News Feed Eradicator](https://chromewebstore.google.com/detail/news-feed-eradicator/cbjlelhojkbifolcocmiijgdpjfpokkk)** if the real issue is feed-based scrolling
- **[DeArrow](https://dearrow.ajay.app/)** if YouTube mainly hooks you through titles and thumbnails
...
- **[Dark Reader](https://darkreader.org/)** to make the web less visually aggressive
- **[I don't care about cookies](https://chromewebstore.google.com/detail/i-dont-care-about-cookies/fihnjjcciajhdojfnbdddfaoknhalnja)** to hide part of the most annoying cookie banners
- **[Auto Dark Mode](https://github.com/AutoDarkMode/Windows-Auto-Night-Mode)** to adapt display settings automatically over the day
...
- **[RescueTime](https://www.rescuetime.com/)** to automatically see where time goes and run Focus Sessions
- **[Clockify](https://clockify.me/)** if your main need is structured tracking by project, client, or task
...
If you want something simple, **[wnr](https://getwnr.com/)** is still a good minimalist option.
...
Still-valid tools:
- **[Brain.fm](https://www.brain.fm/)** if you want a service designed around focus audio
- **[Noisli](https://www.noisli.com/)** if you want simple custom ambience
...
- **[Shortwave](https://www.shortwave.com/)** for a more modern email workflow
- **[Superhuman](https://superhuman.com/)** if email is a central, high-intensity workstation
- **[Simplify Gmail](https://on.simpl.fyi/about)** if you mainly want a calmer Gmail interface
- **[cloudHQ](https://www.cloudhq.net/apps)** if you want a real Gmail/browser productivity toolbox, with **Pause Gmail** as only one example
...
<details>
  ...
  - [Cal Newport](https://calnewport.com/writing/) - on deep work and protecting attention
  - [Nir Eyal - Indistractable](https://www.nirandfar.com/indistractable/) - useful for thinking about internal and external triggers
  - [Frank Slootman - The Knowledge Project](https://fs.blog/knowledge-project-podcast/frank-slootman/) - on the real cost of spreading yourself too thin
</details>
