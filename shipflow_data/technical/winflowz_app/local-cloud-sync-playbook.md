...
evidence:
  ...
  - "WinFlowz keyboard sync controller already implements account-safe seed, hydrate, conflict, queue and account-switch patterns."
...
This playbook is the reusable doctrine for any WinFlowz chantier that turns local-first data into account-backed cloud data.
...
- `shipflow_data/technical/winflowz_app/local-cloud-sync-playbook.md`
- `shipflow_data/technical/winflowz_app/flutter-local-cloud-sync.md`
- `shipflow_data/workflow/specs/*sync*.md`
- `shipflow_data/workflow/verification/*sync*.md`

## Entrypoints

- Spec first: `shipflow_data/workflow/specs/app-local-to-cloud-data-promotion-merge.md`
- Flutter implementation guide: `shipflow_data/technical/winflowz_app/flutter-local-cloud-sync.md`
- Existing code pattern: `winflowz_app/lib/features/keyboard/application/keyboard_sync_controller.dart`
...
flutter analyze
flutter test
python3 /home/claude/shipflow/tools/shipflow_metadata_lint.py shipflow_data/technical/winflowz_app/local-cloud-sync-playbook.md
```
...
Update this playbook whenever WinFlowz adds a new sync domain, changes account-seeding policy, changes conflict-resolution surfaces, changes secret policy, or changes the proof required for reinstall/relogin recovery.
