...
- Shared governance files stay under `shipflow_data/technical/` and not under `docs/`.
- Editorial policy documents own public-claim and content-schema governance, even when engineering changes trigger them.

## Validation

```bash
python3 /home/claude/shipflow/tools/shipflow_metadata_lint.py shipflow_data/technical/code-docs-map.md
rg -n "Maintenance Rule|Validation|Owned Files|Entrypoints" shipflow_data/technical/code-docs-map.md
```
