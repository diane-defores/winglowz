...
next_step: "/sf-prod winflowz_app after bounded keyboard-only ship"
---
...
- Kotlin Android native IME in `android/app/src/main/kotlin/com/winflowz_app/winflowz_app/ime/`.
...
- `shipflow_data/workflow/specs/proprietary-swipe-corner-android-keyboard.md`: after implementation, record that hardcoded corner accents have been replaced by configurable shortcuts.
...
- [ ] Tache 4 : Ajouter le resolver de coins
  - Fichier : `android/app/src/main/kotlin/com/winflowz_app/winflowz_app/ime/KeyboardCornerShortcutResolver.kt`
...
- [ ] Tache 14 : Couvrir les tests natifs de dispatch et regression
  - Fichier : `android/app/src/test/kotlin/com/winflowz_app/winflowz_app/ime/KeyboardCornerShortcutsTest.kt`
...
| 2026-05-14 16:04:15 UTC | sf-ship | GPT-5 Codex | Shipped a bounded keyboard-only commit after explicit user confirmation; excluded unrelated dirty auth files from staging. | shipped | /sf-prod winflowz_app to inspect the Vercel preview before browser QA |

# Current Chantier Flow

- sf-spec: done, draft written in `shipflow_data/workflow/specs/configurable-key-corner-swipes.md`.
