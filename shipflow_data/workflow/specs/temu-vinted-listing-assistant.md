...
depends_on:
  - artifact: "winflowz_site/AGENT.md"
...
Implementation complete and locally verified in `winflowz_site`. Additional increments now add Gemini-powered resale rewriting and direct translated-image generation when server auth is configured. The tool now lives behind authenticated dashboard access instead of public routes. Ship was not requested.
