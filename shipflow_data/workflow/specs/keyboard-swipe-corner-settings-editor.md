...
evidence:
  ...
  - "android/app/src/main/kotlin/com/winflowz_app/winflowz_app/ime/KeyboardCornerShortcuts.kt is the native authority for persisted config validation, presets, parser-backed values and private-field suppression."
...
next_step: "/sf-prod winflowz_app after bounded keyboard editor ship"
---
...
- `android/app/src/main/kotlin/com/winflowz_app/winflowz_app/MainActivity.kt`: seulement si une methode native de validation sans sauvegarde est ajoutee.
- `android/app/src/main/kotlin/com/winflowz_app/winflowz_app/ime/KeyboardCornerShortcuts.kt`: seulement si de nouveaux presets langue ou helpers de validation/export sont requis.
...
| 2026-05-14 16:30:18 UTC | sf-ship | GPT-5 Codex | Shipped a bounded keyboard-editor commit after local Flutter tests, web build and diff checks; excluded unrelated dirty auth/settings/shell files. | shipped | /sf-prod winflowz_app to inspect the Vercel preview |

# Current Chantier Flow

- sf-spec: done, draft written in `shipflow_data/workflow/specs/keyboard-swipe-corner-settings-editor.md`.
...
Prochaine commande recommandee: `/sf-prod winflowz_app` to inspect the matching Vercel preview before browser QA.
