...
linked_systems:
  - "winflowz_site"
  - "shipflow_data/workflow/specs/temu-vinted-listing-assistant.md"
  - "shipflow_data/workflow/research/2026-06-19-marketplaces-api-cli-automation.md"
supersedes: []
evidence:
...
- La spec reste dans `shipflow_data/workflow/specs/` pour préserver la convention chantier.
