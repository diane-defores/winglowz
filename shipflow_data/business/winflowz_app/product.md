...
- Utilisateurs desktop ou iOS/web qui veulent retrouver le concept WinFlowz par overlay, raccourci, partage, clipboard ou autre adaptation native honnête.
...
2. Sur desktop, l'utilisateur déclenche WinFlowz via l'hôte natif disponible: raccourci, fenêtre flottante, clipboard et livraison best-effort quand l'OS l'autorise.
