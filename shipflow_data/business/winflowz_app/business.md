...
WinFlowz cible une application Flutter multi-plateforme avec contrats backend-agnostiques et Firebase comme premier adaptateur distant. Le produit combine un clavier Android natif comme surface prioritaire sur Android, des overlays ou quick actions adaptés par plateforme, dictée locale par packs de langue téléchargeables quand disponible, fallback de transcription explicite, nettoyage IA Claude optionnel avec clé Anthropic locale BYO, historique synchronisé, snippets et dictionnaire personnel.

## Capacités business de référence

| Capacité | Statut | Preuve |
|---|---|---|
| App Flutter multi-plateforme, Android avancé en premier | target-reviewed | `docs/DECISIONS.md`, `winflowz_app/README.md` |
...
| Overlay / quick actions par plateforme | target-reviewed | `shipflow_data/workflow/specs/windows-desktop-overlay-hotkeys-parity.md`, `shipflow_data/workflow/specs/macos-linux-desktop-overlay-hotkeys-parity.md` |
