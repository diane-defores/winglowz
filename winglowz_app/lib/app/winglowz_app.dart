...
class WinGlowz extends ConsumerStatefulWidget {
  const WinGlowz({super.key});

  @override
  ConsumerState<WinGlowz> createState() => _WinGlowzState();
}

class _WinGlowzState extends ConsumerState<WinGlowz> {
  @override
  void initState() {
    super.initState();
