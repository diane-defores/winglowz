...
class OverlayForegroundService : Service() {
    companion object {
        const val ACTION_START = "com.winglowz_app.winglowz_app.overlay.START"
        const val ACTION_STOP = "com.winglowz_app.winglowz_app.overlay.STOP"
        const val ACTION_CANCEL = "com.winglowz_app.winglowz_app.overlay.CANCEL"
        const val ACTION_PAUSE = "com.winglowz_app.winglowz_app.overlay.PAUSE"
        const val ACTION_RESUME = "com.winglowz_app.winglowz_app.overlay.RESUME"
        const val ACTION_SET_STATE = "com.winglowz_app.winglowz_app.overlay.SET_STATE"
        const val ACTION_UPDATE_METER = "com.winglowz_app.winglowz_app.overlay.UPDATE_METER"
        const val ACTION_SET_RESULT_TEXT = "com.winglowz_app.winglowz_app.overlay.SET_RESULT_TEXT"
        const val ACTION_DELIVER_TEXT = "com.winglowz_app.winglowz_app.overlay.DELIVER_TEXT"
        const val ACTION_SET_APPEARANCE = "com.winglowz_app.winglowz_app.overlay.SET_APPEARANCE"
        ...
        private const val notificationChannelId = "winglowz_app_overlay_recording"
        private const val notificationChannelName = "WinGlowz Overlay Recording"
        private const val TAG = "WinGlowzOverlay"

        private const val defaultCollapsedWidth = 50
        private const val initialRightInset = 72
        private const val preferencesName = "winglowz_app_overlay_prefs"
    ...
    private fun showDismissTarget() {
        ...
        dismissTargetView = TextView(this).apply {
            ...
            contentDescription = "Drop here to hide the WinGlowz overlay."
    ...
    private fun buildNotification(contentText: String): Notification {
        ...
        return builder
            .setContentTitle("WinGlowz overlay")
