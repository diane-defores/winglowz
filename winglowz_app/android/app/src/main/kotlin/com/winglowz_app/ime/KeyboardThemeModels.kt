...
object KeyboardThemePresets {
    ...
    const val WINGLOWZ = "winglowz"
    const val WINGLOWZ_LIGHT = "winglowz_light"
    const val WINGLOWZ_DARK = "winglowz_dark"
    ...
    val all =
        listOf(
            ...
            KeyboardThemePreset(WINGLOWZ, "WinGlowz"),
    ...
    private fun normalizedPresetId(presetId: String): String =
        when (presetId) {
            WINGLOWZ_LIGHT, WINGLOWZ_DARK -> WINGLOWZ
            else -> presetId
        }
...
data class KeyboardThemeConfig(
    ...
    fun validated(): KeyboardThemeConfig {
        ...
        val normalizedPresetId =
            when (presetId) {
                KeyboardThemePresets.WINGLOWZ_LIGHT, KeyboardThemePresets.WINGLOWZ_DARK -> KeyboardThemePresets.WINGLOWZ
                else -> presetId
            }
        return copy(
