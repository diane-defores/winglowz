...
import com.winglowz_app.winglowz_app.ime.actions.KeyboardActionLongPressResult
...
class WinGlowzKeyboardView(
    ...
    private var statusText = "WinGlowz"
    private var baseStatusText = "WinGlowz"
    ...
    fun applyPolicy(policy: KeyboardFieldPolicy) {
        ...
        statusText =
            if (policy.privateMode) {
                "WinGlowz - private input (${policy.reason})"
            } else {
                composeStatusText()
            }
    ...
    private fun dispatchUnsafe(
        ...
        when (commandKey.action) {
            ...
            KeyboardKeyAction.ShowClipboardPins -> {
                setStatus("Pinned clipboard list is in WinGlowz app")
            }
            ...
            KeyboardKeyAction.OpenWinGlowzSnippets -> callbacks.onSnippets()
            KeyboardKeyAction.OpenWinGlowzSettings -> callbacks.onSettings()
