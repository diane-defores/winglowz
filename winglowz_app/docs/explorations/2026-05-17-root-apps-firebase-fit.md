...
linked_systems:
  ...
  - "Supabase"
evidence:
  - "/home/claude/winglowz_app/README.md"
...
- Firebase remains the WinGlowz Android adapter.
...
1. WinGlowz app: proceed with Firebase, Firestore rules, emulator proof, Android
