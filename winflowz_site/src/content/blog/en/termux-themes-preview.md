...
**[github.com/dianedef/dotfiles](https://github.com/dianedef/dotfiles)** \u2014 `bash termux.sh` and you're set.

For deploying projects on a server, check out **[ShipFlow](https://github.com/dianedef/ShipFlow)** \u2014 dev environment management with PM2, Caddy and automatic HTTPS.
