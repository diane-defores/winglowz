...
## ShipFlow \u2014 server dev environments

If you develop on a server (VPS, Codespace), ShipFlow automates everything: isolation with Flox, process management with PM2, HTTPS with Caddy, SSH tunnels and public URLs via DuckDNS.

**[github.com/dianedef/ShipFlow](https://github.com/dianedef/ShipFlow)** \u2014 an interactive CLI to deploy and manage your dev environments.
